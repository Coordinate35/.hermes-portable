...
判定原则（含子分类映射，调用 add 时 --cat 和 --sub 都需指定）：

| 场景 | --cat | --sub |
|:---|:---|:---|
| 饭菜、买菜、正餐面包/包子、外卖（果腹类） | 刚性 | 食 |
| 水电、房租、话费、网费、物业 | 刚性 | 住 |
| 地铁、公交、打车、高铁、机票 | 刚性 | 行 |
| 看病、药 | 刚性 | 医 |
| 理发、洗漱、日化（垃圾袋、沐浴露、拖鞋、牙刷、纸巾等） | 刚性 | 护 |
| 饮料、咖啡、奶茶、零食（⚠️ 非果腹饮品） | 娱乐 | 餐饮娱乐 |
| 聚餐、外出就餐（小龙虾等） | 娱乐 | 餐饮娱乐 |
| 电影、游戏、Dota2充值、旅游 | 娱乐 | 休闲 |
| 衣服、数码、购物 | 娱乐 | 购物 |
| 书、课程 | 成长 | 学习 |
| 健身、营养品 | 成长 | 健康 |
| 按摩、理疗（推拿正骨、肩颈治疗，非休闲SPA） | 成长 | 健康 |
| 效率工具 | 成长 | 工具 |
| 礼物、红包 | 其他 | 人情 |
| 无法归类 | 其他 | 杂项 |

核心区分：果腹正餐 → 刚性·食；饮品/零食/外出聚餐 → 娱乐·餐饮娱乐。
